...
pub type SetGlobalU64Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: u64) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalU64ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<u64, KaytonError>;

/// Set/overwrite a named u8 global, return handle.
pub type SetGlobalU8Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: u8) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalU8ByHandleFn = fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<u8, KaytonError>;

/// Set/overwrite a named u32 global, return handle.
pub type SetGlobalU32Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: u32) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalU32ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<u32, KaytonError>;

/// Set/overwrite a named u16 global, return handle.
pub type SetGlobalU16Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: u16) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalU16ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<u16, KaytonError>;

/// Set/overwrite a named u128 global, return handle.
pub type SetGlobalU128Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: u128) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalU128ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<u128, KaytonError>;

/// Set/overwrite a named usize global, return handle.
pub type SetGlobalUsizeFn =
    fn(ctx: &mut KaytonContext, name: &str, value: usize) -> Result<HKayRef, KaytonError>;
