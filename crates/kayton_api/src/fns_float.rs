...
pub type SetGlobalF64Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: f64) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalF64ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<f64, KaytonError>;

/// Set/overwrite a named f32 global, return handle.
pub type SetGlobalF32Fn =
    fn(ctx: &mut KaytonContext, name: &str, value: f32) -> Result<HKayRef, KaytonError>;
...
pub type GetGlobalF32ByHandleFn =
    fn(ctx: &mut KaytonContext, h: HKayRef) -> Result<f32, KaytonError>;
